...
class __TwigTemplate_1e6ab08b5c117e0a946ce916e66e155c9fe8f45f854adc4733247577b998b04e extends \Twig\Template
{
...
$context["group"], "type", []), [0 => "warning", 1 => "error"])) ? (("system-status-report__status-icon system-status-report__status-icon--" . $this->sandbox->ensureToStringAllowed($this->getAttribute($context["group"], "type", [])))) : (""))];
                // line 34
                echo "          <summary";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->env->getExtension('Drupal\Core\Template\TwigExtension')->createAttribute(["class" => (isset($context["summary_classes"]) ? $context["summary_classes"] : null)]), "html", null, true);
                echo " role=\"button\">
            ";
                // line 35
...
";
    ...
    {
        return new Source("", "core/themes/seven/templates/status-report-grouped.html.twig", "/home/xoidh0wq0zy4/public_html/core/themes/seven/templates/status-report-grouped.html.twig");
    }
}

...
class __TwigTemplate_4d96cfa8603f53bd353a3b4da85034c14dd52f8ff65450ef3e68d352ce92c60b extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["set" => 74];
        $filters = ["clean_class" => 76, "escape" => 83, "join" => 84];
        $functions = ["attach_library" => 83];

        try {
            $this->sandbox->checkSecurity(
                ['set'],
                ['clean_class', 'escape', 'join'],
                ['attach_library']
            );
...
<div class=\"";
  ...
  ";
        // line 86
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["content"] ?? null), "field_widget_image", [])), "html", null, true);
        echo "
...
";
    ...
    {
        return new Source("", "themes/ckcs/templates/node--home-widget.html.twig", "/home/chris/projects/CKCS/web/themes/ckcs/templates/node--home-widget.html.twig");
    }
}

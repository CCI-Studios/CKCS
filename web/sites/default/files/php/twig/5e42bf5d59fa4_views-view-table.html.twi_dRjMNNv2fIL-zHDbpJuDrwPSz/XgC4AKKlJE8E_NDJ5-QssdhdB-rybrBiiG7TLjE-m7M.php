...
class __TwigTemplate_d6552d9ff7500bfb3413550a5ed88fbfe384a549f6f2f7b8fd098180fd87f9ca extends \Twig\Template
{
  ...
  ";
    ...
    ";
            ...
            if ((isset($context["caption"]) ? $context["caption"] : null)) {
                // line 46
                echo "      ";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["caption"]) ? $context["caption"] : null)), "html", null, true);
                echo "
    ";
            } else {
                // line 48
    ...
    ";
        ...
        ";
                ...
                if ( !twig_test_empty((isset($context["summary"]) ? $context["summary"] : null))) {
                    // line 53
                    echo "          <summary>";
                    echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["summary"]) ? $context["summary"] : null)), "html", null, true);
                    echo "</summary>
        ";
                }
                // line 55
...
(isset($context["fields"]) ? $context["fields"] : null), $context["key"], [], "array")))];
                    // line 73
                    echo "          ";
                }
                // line 74
                echo "          <th";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($this->getAttribute($context["column"], "attributes", []), "addClass", [0 => (isset($context["column_classes"]) ? $context["column_classes"] : null)], "method"), "setAttribute", [0 => "scope", 1 => "col"], "method")), "html", null, true);
                echo ">";
                // line 75
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if ($this->getAttribute($context["column"], "default_classes", [])) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                        // line 106
                        echo "              ";
                        $context["column_classes"] = twig_array_merge($this->sandbox->ensureToStringAllowed((isset($context["column_classes"]) ? $context["column_classes"] : null)), [0 => ("views-field-" . $this->sandbox->ensureToStringAllowed($context["field"]))]);
                        // line 107
                        echo "            ";
                    }
                    $_parent = $context['_parent'];
                ...
                // line 109
                echo "          <td";
                echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute($this->getAttribute($context["column"], "attributes", []), "addClass", [0 => (isset($context["column_classes"]) ? $context["column_classes"] : null)], "method")), "html", null, true);
                echo ">";
                // line 110
                if ($this->getAttribute($context["column"], "wrapper_element", [])) {
                    // line 111
...
";
    ...
    {
        return new Source("", "core/themes/classy/templates/views/views-view-table.html.twig", "/home/xoidh0wq0zy4/public_html/core/themes/classy/templates/views/views-view-table.html.twig");
    }
}

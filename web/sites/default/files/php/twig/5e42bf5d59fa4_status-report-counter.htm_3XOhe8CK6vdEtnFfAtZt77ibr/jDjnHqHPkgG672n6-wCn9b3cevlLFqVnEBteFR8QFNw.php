...
class __TwigTemplate_f805bba7449fdbc5c7feee56848043ebea19e6f757c582f79bc6c4148fda6da2 extends \Twig\Template
{
...
(isset($context["severity"]) ? $context["severity"] : null)))];
  ...
  <span class=\"system-status-counter__status-icon system-status-counter__status-icon--";
        // line 21
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["severity"]) ? $context["severity"] : null)), "html", null, true);
        echo "\"></span>
  <span class=\"system-status-counter__status-title\">
    <span class=\"system-status-counter__title-count\">";
        // line 23
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["amount"]) ? $context["amount"] : null)), "html", null, true);
        echo " ";
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed((isset($context["text"]) ? $context["text"] : null)), "html", null, true);
        echo "</span>
...
";
    ...
    {
        return new Source("", "core/themes/seven/templates/status-report-counter.html.twig", "/home/xoidh0wq0zy4/public_html/core/themes/seven/templates/status-report-counter.html.twig");
    }
}
